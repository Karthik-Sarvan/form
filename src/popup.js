...
export default function Popup({ onClose }) {
  return (
    <div
      className="bg-black h-[100vh] w-[100vw] flex justify-center items-center fixed top-0 left-0 z-50 bg-opacity-40"
      onClick={() => {
        console.log("clicked");
        onClose();
      }}
    >
      <div
        ...
        className="bg-white relative md:h-[50vh] lg:h-[50vh] h-[30vh] md:w-[50vw] lg:w-[50vw] w-[95vw] rounded-xl justify-center items-center flex flex-col gap-5 md:text-xl lg:text-xl text-base p-5"
      >
