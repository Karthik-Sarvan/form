    ...
    <div className="App w-[90%] md:w-[80%] mx-auto my-[2%] border-x-2 border-b-2 border-[#c0dce4] rounded-[20px]">
      ...
      <div className="w-full p-5 ">
        ...
        <form
          ...
          <div className="flex md:flex-row lg:flex-row flex-col w-full mt-10">
            <button
              type="submit"
              className="bg-[#5cb85c] mx-auto md:w-fit lg:w-fit w-full text-white md:px-10 py-2 text-xl rounded-md">
              Submit
            </button>
